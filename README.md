...
- **Feedforward Neural Network** — 3 hidden layers, ReLU, Dropout, trained via backpropagation for 150 epochs (W10, W11)
- **Frontend** — Gradio UI + Claude API for salary prediction and career advice (W13)
